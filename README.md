...
| `nemo` | `core` (8080 Qwen3-8B) | Home Assistant keeps using nemo's Ollama; its model must move `gemma4:e4b` → `qwen3:4b-instruct-2507-q4_K_M` (pulled, fits beside core; the plain `qwen3:4b` tag is the thinking variant). Runbook §6 |
