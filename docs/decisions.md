...
| 8 | nemo Qwen3-8B "resident" | resident since 2026-09-10 11:00 | Home Assistant stays on nemo's Ollama but with `qwen3:4b-instruct-2507-q4_K_M` (3.6 GB; the bare `qwen3:4b` tag is the thinking variant and dumps reasoning into HA's answers) instead of `gemma4:e4b` (10.6 GB); measured together: 3.5 GB free. The operator's first choice (nema's Ollama) was measured and does not fit next to nema's router — runbook §6 |
